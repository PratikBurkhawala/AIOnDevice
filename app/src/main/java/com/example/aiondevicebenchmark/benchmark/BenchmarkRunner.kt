        ...
        repeat(totalGenerations) { index ->
            ...
            val record = BenchmarkRecord(
                ...
                observation = ObservationJson(
                    summary = "Generated by the benchmark harness.",
                    ...
                    notes = listOf("GPU/NPU utilization is stored as unavailable unless exposed by a runtime or profiler."),
                ),
            )
